...
import duckbillDinosaur from "@/data/dinosaur-images/duckbill.gif";
import hornedDinosaur from "@/data/dinosaur-images/toro.gif";
import lizard from "@/data/dinosaur-images/lizard.gif";
...
import landTurtle from "@/data/dinosaur-images/turtle_land.gif";

import hornedDinosaurTime from "@/data/timeline-images/Timeline-HornedDino.gif";
import turtleSeaTime from "@/data/timeline-images/Timeline-Turtle.gif";
import sauropodTime from "@/data/timeline-images/Timeline-Sauropod.gif";
import theropodLargeTime from "@/data/timeline-images/Timeline-Theropod(large).gif";
import birdTime from "@/data/timeline-images/Timeline-Bird.gif";
import theropodSmallTime from "@/data/timeline-images/Timeline-Theropod(small).gif";
import duckbillDinosaurTime from "@/data/timeline-images/Timeline-DuckbillDino.gif";
import armoredDinosaurTime from "@/data/timeline-images/Timeline-ArmoredDino.gif";
import crocodileLargeTime from "@/data/timeline-images/Timeline-Crocodile.gif";
import plesiosaurShortNeckTime from "@/data/timeline-images/Timeline-Plesiosaur.gif";
import plesiosaurLongNeckTime from "@/data/timeline-images/Timeline-Plesiosaur.gif";
import pterosaurTime from "@/data/timeline-images/Timeline-Pterosaur.gif";
import mosasaurTime from "@/data/timeline-images/Timeline-Mosasaur.gif";
import crocodileSmallTime from "@/data/timeline-images/Timeline-Crocodile.gif";
import snakeTime from "@/data/timeline-images/Timeline-Snake.gif";
import lizardTime from "@/data/timeline-images/Timeline-Lizard.gif";
import turtleLandTime from "@/data/timeline-images/Timeline-Turtle.gif";
